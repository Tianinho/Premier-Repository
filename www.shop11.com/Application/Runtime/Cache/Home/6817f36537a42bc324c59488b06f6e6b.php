...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="/www.shop11.com/Public/Home/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="/www.shop11.com/Public/Home/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">

    <link href="/www.shop11.com/Public/Home/css/animate.min.css" rel="stylesheet">
    <link href="/www.shop11.com/Public/Home/css/style.min862f.css?v=4.1.0" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="/www.shop11.com/Public/Home/js/jquery.min.js?v=2.1.4"></script>
    <script src="/www.shop11.com/Public/Home/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="/www.shop11.com/Public/Home/js/content.min.js?v=1.0.0"></script>
